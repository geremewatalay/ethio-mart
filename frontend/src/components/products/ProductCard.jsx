  ...
  return (
    ...
    >
      ...
      <div className="relative aspect-square overflow-hidden bg-gray-50 p-6">
        ...
        {/* Add to Cart */}
        <button className="absolute left-4 right-4 -bottom-16 flex items-center justify-center gap-2 rounded-2xl bg-slate-900 py-3 text-sm font-bold text-white transition-all duration-500 hover:bg-emerald-600 group-hover:bottom-4">
